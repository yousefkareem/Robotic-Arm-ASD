...
def file_to_vectors(file_name,
                    ...
                    n_mfcc=20):
    """
    convert file_name to a vector array using MFCCs and their derivatives.
    ...
    n_vectors = features.shape[1] - n_frames + 1
    ...
    for t in range(n_frames):
        vectors[:, 3 * n_mfcc * t : 3 * n_mfcc * (t + 1)] = features[:, t : t + n_vectors].T
